...
class NsdRoomAdvertiser(private val nsdManager: NsdManager) {
    ...
    suspend fun advertise(roomCode: String, port: Int): String = suspendCancellableCoroutine { cont ->
        ...
        val listener = object : NsdManager.RegistrationListener {
            ...
            override fun onRegistrationFailed(info: NsdServiceInfo, errorCode: Int) {
                ...
                if (cont.isActive) cont.resumeWithException(NsdOperationException("Falha ao registrar serviço NSD (código $errorCode)"))
            }
